...
def create_og_image():
    ...
    draw.text((100, 390), "지역·이름으로 유치원을 검색하세요", fill=GRAY, font=sub_font)

    icon_font = load_font(26, bold=True)
    boxes = [
        ("전국 7,151개 유치원", ACCENT2),
        ("학급·정원 확인", (37, 99, 235)),
        ("위치·전화번호", (234, 88, 12)),
    ]
    cx, y = 100, 456
    ...
    draw.text((100, 550), "wooakinder.wooahouse.com", fill=ACCENT, font=domain_font)
